...
def render_nfl_player_search(
    ...
    user must press "Load Roster" first. This also means a Player
    ...
    the selector disappears until Load Roster is pressed again for the
    ...
    _is_loaded = _current_selection in st.session_state[_loaded_key]
    ...
    # revisiting an already-loaded Team/Position costs nothing extra.
